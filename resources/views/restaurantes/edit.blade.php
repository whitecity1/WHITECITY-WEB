...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">EDITAR RESTAURANTES </h1>

    <form class="mt-4"  action="{{route('restaurantes.update', $restaurantesArray['id'])}}" method="POST" enctype="multipart/form-data">
        ...
        id="restauante" name="restaurante" value="{{$restaurantesArray['restaurante']}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$restaurantesArray['telefono']}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$restaurantesArray['correo']}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$restaurantesArray['mun_ubicado']}}">
        ...
        id="direccion" name="direccion" value="{{$restaurantesArray['direccion']}}">
        ...
        id="apertura" name="apertura" value="{{$restaurantesArray['apertura']}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$restaurantesArray['cierre']}}">
