...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="{{'http://whitecityApi.test/v1/autoridades/'.$autoridadesArray['id']}}" method="POST" enctype="multipart/form-data">
        ...
        id="nombre_entidad" name="nombre_entidad" value="{{$autoridadesArray['nombre_entidad']}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$autoridadesArray['telefono']}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$autoridadesArray['correo']}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$autoridadesArray['mun_ubicado']}}">
        ...
        id="direccion" name="direccion" value="{{$autoridadesArray['direccion']}}">
        ...
        id="apertura" name="apertura" value="{{$autoridadesArray['apertura']}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$autoridadesArray['cierre']}}">
