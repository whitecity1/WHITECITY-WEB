...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="{{'http://whitecityApi.test/v1/centroscomerciales/'.$ccomercialArray['id']}}" method="POST" enctype="multipart/form-data">
        ...
        id="centrocomercial" name="centrocomercial" value="{{$ccomercialArray['centrocomercial']}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$ccomercialArray['telefono']}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$ccomercialArray['correo']}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="municipio" name="municipio" value="{{$ccomercialArray['municipio']}}">
        ...
        id="direccion" name="direccion" value="{{$ccomercialArray['direccion']}}">
        ...
        id="apertura" name="apertura" value="{{$ccomercialArray['apertura']}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$ccomercialArray['cierre']}}">
