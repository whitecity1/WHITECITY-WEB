...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="{{'http://whitecityApi.test/v1/rutasturisticas/'.$rutasturisticasArray['id']}}" method="POST" enctype="multipart/form-data">
        ...
        id="ruta_turistica" name="ruta_turistica"  value="{{$rutasturisticasArray['ruta_turistica']}}">
        ...
        Descripción:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="descripcion" name="descripcion"  value="{{$rutasturisticasArray['descripcion']}}">
        @error('descripcion')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        Municipio de ubicación
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="municipio_ubicada" name="municipio_ubicada" value="{{$rutasturisticasArray['municipio_ubicada']}}" >
        ...
        Dirección :
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="direccion_ruta" name="direccion_ruta" value="{{$rutasturisticasArray['direccion_ruta']}}">
        ...
        Numero de contacto:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="contactos" name="contactos" value="{{$rutasturisticasArray['contactos']}}">
        ...
        id="h_apertura" name="h_apertura" value="{{$rutasturisticasArray['h_apertura']}}">
        ...
        Fin atención:
        <input type="time" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="h_cierre" name="h_cierre" value="{{$rutasturisticasArray['h_cierre']}}">
        ...
        Tipo ruta turística:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="tipo_rutaTur" name="tipo_rutaTur" value="{{$rutasturisticasArray['tipo_rutaTur']}}">
