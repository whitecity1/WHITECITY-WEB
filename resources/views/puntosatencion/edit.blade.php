...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="{{route('puntosatencion.update', $puntosArray['id'])}}" method="POST" enctype="multipart/form-data">
        ...
        id="nombre_puntoatencion" name="nombre_puntoatencion" value="{{$puntosArray['nombre_puntoatencion']}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$puntosArray['telefono']}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$puntosArray['correo']}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$puntosArray['mun_ubicado']}}">
        ...
        id="direccion" name="direccion" value="{{$puntosArray['direccion']}}">
        ...
        id="apertura" name="apertura" value="{{$puntosArray['apertura']}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$puntosArray['cierre']}}">
