...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="{{'http://whitecityApi.test/v1/hoteles/'.$hotelArray['id']}}" method="POST" enctype="multipart/form-data">
        ...
        id="hotel" name="hotel" value="{{$hotelArray['hotel']}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$hotelArray['telefono']}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$hotelArray['correo']}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$hotelArray['mun_ubicado']}}">
        ...
        id="direccion" name="direccion" value="{{$hotelArray['direccion']}}">
        ...
        id="apertura" name="apertura" value="{{$hotelArray['apertura']}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$hotelArray['cierre']}}">
